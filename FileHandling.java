...
public class FileHandling {
    ...
    public boolean insertBox() {
        ...
        btnDbInsert.addActionListener(e -> {
            try {
        ...
        btnDbCancel.addActionListener(e -> insertDialog.dispose());
    ...
    void updateBox() {
        ...
        btnDbUpdate.addActionListener(e -> {
            if (!tfQuestion.getText().isEmpty() && !tfAnswer.getText().isEmpty()) {
        ...
        btnDbCancel.addActionListener(e -> updateDialog.dispose());
    ...
    void deleteBox() {
        ...
        btnDbDelete.addActionListener(e -> {
            deleteContent();
            updateFile();
            deleteDialog.dispose();
        });

        btnDbCancel.addActionListener(e -> deleteDialog.dispose());
